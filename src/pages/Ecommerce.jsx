    ...
    <div className="mt-12">
        ...
        bg-center">
          ...
          items-center">
            <div>
              ...
              <p className="text-2xl">$33,333.33</p>
            </div>
          </div>
          <div className="mt-6">
            <Button 
      ...
      justify-center">
          ...
          rounded-2xl md:w-780">
            ...
            <div className="empty-10 flex gap-10 
              ...
              border-color m-4 pr-10">
                <div>
                  <p>
                    ...
                    <span className="p-1.5 hover:drop-shadow-xl cursor-pointer rounded-full text-white bg-green-400 m1-3 text-xs">24%</span>
                  </p>
                  <p className="text-gray-500 mt-1">Budget</p>
                </div>
                <div className="mt-8">
                  <p>
                    <span className="text-3xl font-semibold">$44,444</span>
                  </p>
